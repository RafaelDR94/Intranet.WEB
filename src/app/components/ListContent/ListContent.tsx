      ...
      {dataTable.length > 0 && (
        <div className="bg-white-100 rounded-2xl shadow-md">
          {dataTable.map((item, index) => {
            const detailContent = renderDetails?.(item);
            ...
            return (
              <div key={item.id || index} className="border-b border-gray-20 last:border-b-0">
                ...
                {detailContent && <div className="px-4 pb-4 pt-0">{detailContent}</div>}
              </div>
            );
          })}
        </div>
          ...
          {dataTableSecondary.map((item, index) => {
            ...
            return (
              <div key={item.id || index} className="border-b border-gray-20 last:border-b-0">
                ...
                {detailContent && <div className="px-2 pb-3 pt-0">{detailContent}</div>}
              </div>
            );
          })}
        </div>
