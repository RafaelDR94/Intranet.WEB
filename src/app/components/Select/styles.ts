export const baseStyles = {
  ...
  // OJO: ahora el menú lo posiciona Floating UI, así que no pongas absolute/top/left aquí.
menu:
    'absolute z-50 left-0 top-full mt-1 w-full rounded-md bg-white shadow-md max-h-[120px] overflow-y-auto overscroll-contain border border-gray-30',
