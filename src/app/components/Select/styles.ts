export const baseStyles = {
  ...
  option:
    "flex items-start justify-between gap-2 px-3 py-2 min-h-10 text-sm leading-6 cursor-pointer whitespace-normal break-words hover:bg-green-10 hover:text-black-100",
