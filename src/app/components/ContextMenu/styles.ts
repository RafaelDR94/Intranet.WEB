export const contextMenuStyles = {
  ...
  Menu: 'absolute mt-2 w-48 rounded-md shadow-300 bg-white-100 z-50 p-1',
  ItemBase:
    'w-full flex justify-between items-center px-4 py-2 text-left font-normal text-b1 rounded-sm',
