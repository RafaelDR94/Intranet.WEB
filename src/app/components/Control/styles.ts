export const controlStyles = {
  ...
  controlOnDecrement:
    "px-4 py-2 flex-1 text-center transition text-black-100 hover:bg-green-10",
  controlOnIncrement:
    "px-4 py-2 flex-1 text-center transition text-black-100 hover:bg-green-10",
  controlDivider: "w-[1px] h-6 bg-green-60",
  controlTextFilled: "text-green-100 hover:bg-green-20",
