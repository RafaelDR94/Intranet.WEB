 ...
 */
export const pGet =
  (fn: IntranetGetType, ok: StatusRange = DEFAULT_OK) =>
 ...
 */
export const pDelete =
  (fn: IntranetDeleteType, ok: StatusRange = DEFAULT_OK) =>
  (url: string, data?: unknown): Promise<AxiosResponse> =>
    new Promise((resolve, reject) => {
      try {
        ...
        if (data === undefined) {
          (fn as (url: string, callback: (res: AxiosResponse) => void) => void)(
            url,
            callback,
          );
          return;
 ...
 */
export const pPost =
  (fn: IntranetPostType, ok: StatusRange = DEFAULT_OK) =>
 ...
 */
export const pPut =
  (fn: IntranetPutType, ok: StatusRange = DEFAULT_OK) =>
  (url: string, data: any): Promise<AxiosResponse> =>
    new Promise((resolve, reject) => {
      try {
        fn(url, data, (res: AxiosResponse) => {
