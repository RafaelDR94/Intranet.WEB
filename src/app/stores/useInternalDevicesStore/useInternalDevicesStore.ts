...
export const useInternalDevicesStore = createWithEqualityFn<InternalDevicesState>()(
  devtools((set, get) => ({
    ...initialCollections,
    ...initialFlags,
    ...
    deleteDevice: (id, lowMotive, idUser) =>
      deleteInternalDevice(set, get, id, lowMotive, idUser),
    ...
    deleteDeviceAssignment: (id, lowMotive, idUser) =>
      deleteDeviceAssignment(set, get, id, lowMotive, idUser),
