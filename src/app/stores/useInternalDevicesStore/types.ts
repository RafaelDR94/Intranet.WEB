import type {
  ...
  InternalDeviceAssignmentDelete,
...
export type InternalDevicesState = {
  ...
  unassignedDevices: InternalDevice[];
  deactivatedDevices: InternalDevice[];
  ...
  loadingUnassignedDevices: boolean;
  loadingDeactivatedDevices: boolean;
  ...
  successGetUnassignedDevices: boolean;
  successGetDeactivatedDevices: boolean;
  ...
  fetchUnassignedDevices: (force?: boolean) => Promise<InternalDevice[] | null>;
