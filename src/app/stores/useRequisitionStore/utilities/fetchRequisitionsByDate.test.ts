...
import { fetchRequisitionsByDate } from './fetchRequisitionsByDate'
...
describe('fetchRequisitionsByDate util', () => {
  it('llena requisitions y apaga loading', async () => {
    ...
    await fetchRequisitionsByDate('2025-01-01', '2025-01-31', set, get)
