'use client'
import type { Set, Get, VerifyPasswordRecoveryCodePayload } from '../types'

import {
  PasswordRecoveryVerificationResponseMap,
  PostVerifyPasswordRecoveryCodeMap,
} from '@/app/mappings/auth/auth.mapper'
import type { PasswordRecoveryVerificationResponse } from '@/app/mappings/auth/auth.types'
import { AuthPasswordRecoveryVerifyCode } from '@/app/configurations/Axios/urls'
...
export const verifyPasswordRecoveryCode = async (
  ...
  try {
    ...
    const response = await post(
      AuthPasswordRecoveryVerifyCode,
      PostVerifyPasswordRecoveryCodeMap(payload),
    )
