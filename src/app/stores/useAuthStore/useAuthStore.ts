...
export const useAuthStore = createWithEqualityFn<AuthState>()(
  devtools((set, get) => ({
    ...
    setFirebaseSessionStatus: (firebaseSessionStatus) => set({ firebaseSessionStatus }),
    ...
    registerUserPasskeyOptions: (deviceName) => registerUserPasskeyOptions(set, get, deviceName),
