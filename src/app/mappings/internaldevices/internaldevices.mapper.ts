...
export const InternalDeviceTypesMap = (
  list: unknown[],
): InternalDeviceType[] =>
...
export const InternalDeviceViewPayloadMap = (
  ...
  return {
    ...
    MacWifiAddress: toString(record.mac_wifi_address ?? record.macWifiAddress),
...
export const InternalDeviceAssignmentHistoryMap = (
  ...
  return {
    ...
    devicename:
      toNullableString(
        record.devicename ?? record.device_name ?? record.deviceName,
      ) ?? undefined,
    ...
    date:
      toNullableString(
        record.date ?? record.assigned_at ?? record.assignedAt,
      ) ??
      dateCreated ??
      undefined,
