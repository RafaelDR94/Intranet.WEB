import { EditableViaticsRow, EditableViaticsTableLabels } from './types';
...
export const mutedBodyTextClasses = 'text-[14px] leading-5 font-normal text-gray-40';

export const inputClasses =
  'w-full border border-transparent bg-transparent px-1 py-0.5 text-[14px] leading-5 text-gray-70 outline-none transition-colors focus:border-turquoise-60 focus:bg-white';

export const columnWidths: Record<keyof Omit<EditableViaticsRow, 'id'>, string> = {
  concept: 'w-[24%]',
  nationalQuoted: 'w-[10%]',
  foreignQuoted: 'w-[10%]',
  people: 'w-[10%]',
