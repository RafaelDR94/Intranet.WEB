...
export const subLink = 'block px-2 py-1 hover:bg-blue-90 rounded text-white-10 text-b3 font-regular';
export const footer = 'mt-auto text-sm text-white-10 w-full px-3 py-4';
