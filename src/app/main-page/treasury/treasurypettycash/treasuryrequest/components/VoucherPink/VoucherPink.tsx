...
/**
 * Formulario para crear o editar vales rosa desde Tesoreria.
...
const TreasuryVoucherPink: React.FC<VoucherFormProps> = ({
  ...
  return (
    <>
      <div data-tour="treasury-request-pink-form">
        <FormsLayout
          ...
          primaryButtonDataTour="treasury-request-pink-submit"
          secondaryButtonDataTour="treasury-request-pink-secondary"
        >
          <DynamicForm
            loadingFormInfo={loadingFormInfo}
            fields={fields}
