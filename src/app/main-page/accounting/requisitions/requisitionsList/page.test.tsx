...
describe("RequisitionsList page", () => {
  it("renders details and requisitions table by default", () => {
  ...
  it("redirects files view to validate invoices with employee id", async () => {
    useSearchParamsMock.mockReturnValueOnce(
      new URLSearchParams(
        "label=Archivos%20Bruno&idEmployee=emp-1&employeeName=Bruno%20Mendoza",
      ),
    );
  ...
  it("redirects files view to validate invoices with requisition code when requisition context exists", async () => {
    useSearchParamsMock.mockReturnValueOnce(
      new URLSearchParams(
        "label=Archivos%20REQ-2026-001&idEmployee=emp-1&idRequisition=req-1&requisitionCode=REQ-2026-001&employeeName=Bruno%20Mendoza",
      ),
    );
