...
import {
  formatDate,
  normalizeStatusType,
} from "../../travelexpenserequest/utilities/travelExpenseRequestHelpers";

type RequisitionRequestsTableProps = {
  onRefresh: () => void;
...
/** Table for the Operations requisition request summary. */
export const RequisitionRequestsTable = ({
  onRefresh,
  onViewDetails,
  rows,
