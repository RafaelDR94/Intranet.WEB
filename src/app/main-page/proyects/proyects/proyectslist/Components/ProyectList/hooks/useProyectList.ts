...
const useProyectList = () => {
    ...
    const handleNew = () => router.push('/main-page/proyects/proyects/newproyect');

    const handleEdit = (p: Proyect) => {

        setCurrentProyect(p);

        router.push(`/main-page/proyects/proyects/newproyect?id=${p.id}`);
    ...
    const handleView = (p: Proyect) => {
        ...
        reset();
        setCurrentProyect(p);
        router.push(`/main-page/proyects/proyects/proyectslist?id=${p.id}&label=${p.proyectKey}`);
    ...
    const handeReport = (p: Proyect) => {
        ...
        reset();
        setCurrentProyect(p);
        router.push(`/main-page/proyects/proyects/proyectslist?id=${p.id}&label=${p.proyectKey}&newReport=true`);
    }
