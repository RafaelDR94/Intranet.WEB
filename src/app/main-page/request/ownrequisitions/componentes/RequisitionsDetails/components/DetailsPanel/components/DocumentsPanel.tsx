...
import { DocumentsPanelProps } from "../types";
...
const DocumentsPanel: React.FC<DocumentsPanelProps> = ({
  ...
  const isTicket = Boolean(selected?.billingdocument_id?.startsWith("ticket-"));
  ...
  const dataEdit: HistoryRow | null = {
    id: selected.id,
    ...
    >
      ...
      {!isTicket && (
        <PopUp
          ...
          content="Deja aqui un comentario para que tu companero sepa la razon del rechazo de su factura"
