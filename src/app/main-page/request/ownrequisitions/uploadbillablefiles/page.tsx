...
import BatchInvoicesForms from "./components/BatchInvoicesForms/BatchInvoicesForms";
    ...
    <InvoicesProvider>
      {loading ? (
        <div className="px-4 py-10">
          <div className="border-gray-20 bg-white-90 shadow-300 mx-auto max-w-2xl overflow-hidden rounded-2xl border">
            <div className="from-green-90 to-blue-80 h-1 w-full bg-gradient-to-r" />
            <div className="flex flex-col items-center gap-4 p-8 text-center">
              <div className="bg-white-80 h-12 w-12 animate-pulse rounded-full" />
              <div className="w-full max-w-md space-y-2">
                <div className="bg-white-80 mx-auto h-4 w-3/5 animate-pulse rounded" />
                <div className="bg-white-80 mx-auto h-3 w-4/5 animate-pulse rounded" />
              </div>
        ...
        <div className="px-4 py-10">
          <div className="border-gray-20 bg-white-90 shadow-300 mx-auto max-w-2xl overflow-hidden rounded-2xl border">
            <div className="from-green-90 to-blue-80 h-1 w-full bg-gradient-to-r" />
            <div className="flex flex-col items-center gap-4 p-8 text-center">
              <div className="bg-white-80 flex h-12 w-12 items-center justify-center rounded-full">
                <FileUp className="text-green-90 h-6 w-6" aria-hidden="true" />
              </div>

              <div className="space-y-2">
                <h2 className="text-s1 text-black-100 font-semibold">
                  No cuentas con requisiciones activas.
                </h2>
                <p className="text-b3 text-gray-70 mx-auto max-w-xl">
